...
public class LoginClient extends JFrame{
	...
	private void initialize() { // it will initialize the components of UI
		...
		password.setBounds(207, 130, 276, 61);
		...
		*/
		...
		clientLoginBtn.setBounds(207, 200, 132, 61);
		...
		lblNewLabe2.setFont(new Font("Tahoma", Font.PLAIN, 17));
		lblNewLabe2.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabe2.setBounds(44, 140, 132, 47);
